...
public class BlogController {
    ...
    @GetMapping("/{id}/{isMarkDown}")
    public JsonResult<FullBlogDTO> get(@PathVariable String id, @PathVariable("isMarkDown") boolean isMarkDown) {
        return blogService.get(id, isMarkDown);
    }
    ...
    public JsonResult<Boolean> create(@RequestBody BlogDTO blog) {
        return JsonResult.of(blogApiService.create(blog, true));
    }

    @PutMapping("/createHtml")
    public JsonResult<Boolean> createHtml(@RequestBody BlogDTO blog) {
        return JsonResult.of(blogApiService.create(blog, false));
    }
    ...
    public JsonResult<Boolean> update(@RequestBody BlogDTO blog) {
        return JsonResult.of(blogApiService.update(blog, true));
    }

    @PostMapping("/updateHtml")
    public JsonResult<Boolean> updateHtml(@RequestBody BlogDTO blog) {
        return JsonResult.of(blogApiService.update(blog, false));
    }
    ...
    @PostMapping("/sync/{id}/{isMarkDown}")
    public JsonResult<Boolean> sync(@PathVariable("id") String id, @PathVariable("isMarkDown") boolean isMarkDown) {
        blogApiService.sync(id, isMarkDown);
