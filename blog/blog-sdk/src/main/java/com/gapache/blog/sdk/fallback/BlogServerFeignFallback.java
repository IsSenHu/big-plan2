...
public class BlogServerFeignFallback implements BlogServerFeign {
    ...
    @Override
    public JsonResult<Boolean> createHtml(BlogDTO dto) {
        return null;
    }
    ...
    @Override
    public JsonResult<Boolean> updateHtml(BlogDTO blog) {
        return null;
    }
    ...
    @Override
    public JsonResult<Boolean> sync(String id, boolean isMarkDown) {
        return null;
    }
}
